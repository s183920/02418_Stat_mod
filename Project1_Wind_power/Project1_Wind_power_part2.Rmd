...
plot(seq(0.01,1,0.01), sapply(seq(0.01,1,0.01), lp.lambda1, y=windpower))
'
...
windpower <- trans1(opt.lambda.trans1$minimum,windpower)
...
modelny2 <- lm(trans2(opt.lambda.trans2$maximum,wind_data$pow.obs.norm) ~ ws30 + I(ws30^2),  data=wind_data) #hedder også model6
