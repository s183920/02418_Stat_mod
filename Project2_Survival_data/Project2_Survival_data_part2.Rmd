...
cat("The test statistic for H0: theta = 0 is ", z, ", which yields a p-vlaue of ", pnorm(z))

```

As seen above the p-value leans towards a rejection of the null hypothesis $\beta_1 = 0$ and the score test there shows that AZT and $\beta_1$ has an effect.
